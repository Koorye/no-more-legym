...
tk.Label(frame1, text='Username:').pack()
...
activity_info.heading('code', text='代码')
activity_info.heading('name', text='名称')
activity_info.heading('status', text='状态')
activity_info.heading('interval', text='剩余时间')
...
# username.insert(0, '15869663967')
# password.insert(0, 'honmameiko0.0')
